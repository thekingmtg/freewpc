...
G2: Elevator Motor, motor, nosearch, duty(SOL_DUTY_50)
...
CryoClawDrive: driver(bivar2), forward_sol=SOL_CLAW_LEFT, reverse_sol=SOL_CLAW_RIGHT, forward_sw=SW_CLAW_POSITION_1, reverse_sw=SW_CLAW_POSITION_2, includetest(yes)
...
cryoclawdrive:	#autogenerated-test, see defintion in [templates] section.
...
acmag hit effect: page(MACHINE_PAGE), PRI_GAME_QUICK2, D_RESTARTABLE
...
standupfrenzy hit effect: page(MACHINE_PAGE), PRI_GAME_QUICK2, D_RESTARTABLE
...
capture simon hit effect: page(MACHINE2_PAGE), PRI_GAME_QUICK2, D_RESTARTABLE
...
prison break hit effect: page(MACHINE2_PAGE), PRI_GAME_QUICK2, D_RESTARTABLE
...
explode hit effect: page(MACHINE2_PAGE), PRI_GAME_QUICK2, D_RESTARTABLE
