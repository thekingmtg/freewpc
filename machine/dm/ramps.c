...
U8 		TotalNumOfSounds = 25; //num between 0 and 24 == 25 total
...
void ramp_sounds (void) {
	...
	sound_start (ST_EFFECT, rampSoundsArray[ramp_SoundCounter], SL_1S, PRI_GAME_QUICK5);
}
