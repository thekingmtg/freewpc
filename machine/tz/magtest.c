...
void tz_magnet_test_draw (void)
{
	...
	dmd_alloc_low_clean ();
	font_render_string_center (&font_var5, 64, 2, "MAGNET TEST");
	font_render_string_center (&font_var5, 64, 8, opt->name);
	sprintf ("SW: %d", left_magnet_swag);
	font_render_string_center (&font_var5, 32, 16, sprintf_buffer);
