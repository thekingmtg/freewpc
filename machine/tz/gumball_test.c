...
void tz_gumball_test_draw (void)
{
	...
	dmd_alloc_low_clean ();
	font_render_string_center (&font_var5, 64, 2, "GUMBALL TEST");
	switch (gumball_op)
	{
	...
	font_render_string_center (&font_var5, 32, 10, sprintf_buffer);

	sprintf ("%d", gumball_count);
	font_render_string_center (&font_var5, 96, 10, sprintf_buffer);
