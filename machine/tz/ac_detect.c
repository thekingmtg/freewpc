...
{
	dmd_alloc_low_clean ();
	font_render_string_center (&font_var5, 64, 2, "AC TEST");
	...
	font_render_string_right (&font_var5, 54, 22, sprintf_buffer);
	sprintf ("%d ERRS", ac_zerocross_errors);
	font_render_string_left (&font_var5, 84, 22, sprintf_buffer);
