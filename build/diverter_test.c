...
struct window_ops diverter_test_window = {
	DEFAULT_WINDOW,
...
struct menu diverter_test_item = {
	.name = "DIVERTER TEST", // needs DIVERTER for uppercase version of 'self' as test menu font doesn't have lower-case letters.
	.flags = M_ITEM,
	.var = { .subwindow = { &diverter_test_window, NULL } },
};
